                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">Ordered a laptop online and received it within a few days. The packaging was secure, and the product was exactly as described. Will definitely shop here again.</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Kamal Nayan Upadhyay</h2>
                                <p className="text-gray-500">Samastipur, Bihar</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">At the computer shop, I found exactly what I was looking for. The staff were incredibly knowledgeable and helpful, making the experience enjoyable. I highly recommend them for their great selection and top-notch service!</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">Had an issue with a product, and the customer service team went above and beyond to resolve it quickly. Very impressed with their professionalism and dedication to customer satisfaction.</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Sanjay Kumar </h2>
                                <p className="text-gray-500">Samastipur, Bihar</p>
                            </div>
                        </div>
                    </div>
